...
# Initialize a y-coordinate variable
line_y = desc1_y

for line in description_lines_desc1:
    ...
    text_bbox = draw.textbbox((line_x, line_y), line, font=description_font)

    # Calculate the text height from the bounding box
